...
describe Category do 
  ...
  describe "#recent_videos" do
    it "returns the videos in the reverse chronical order by created at" do
      ...
      vid1 = Video.create(title: "Futurama", description: "Funny cartoon", category: comedies, created_at: 1.day.ago)
      vid2 = Video.create(title: "Archer", description: "Funnier cartoon", category: comedies)
      expect(comedies.recent_videos).to eq([vid2, vid1])
    end
    ...
    it "returns the most recent 6 videos" do 
      ...
      tonight_show = Video.create(title: "Tonight Show", description: "Late night variety", category: comedies, created_at: 1.day.ago)
